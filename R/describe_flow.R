...
flowDf <- as_tibble(as.list(c('topfacN' = topfacN, 'citeN' = citeN, 'combinedN' = combinedN, 'differenceN' = differenceN, 'filteredN' = filteredN, 'finalN' = finalN, 'sherpadiffN' = sherpadiffN))) 
}